...
public class UserEditModal extends DefaultScreenAbstract implements DefaultScreenInterface {
    ...
    private static List<String> getEmptyFields(UserUpdateModel updateModel) {
        var fields = new ArrayList<Field>();
        for (var field : UserUpdateModel.class.getDeclaredFields()) {
        ...
        for (Field field : fields) {
            try {
                if (StringUtils.isNullOrEmpty(field.get(updateModel).toString())) {
